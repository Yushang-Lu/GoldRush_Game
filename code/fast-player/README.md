...
- 可能有效的算法：asm 25格展开，AVX-512 25格，asm 9格，asm十字4格，asm十字4格+u0死守，以及无扫描的相位游走+脚下捡币。
- 可能的有效策略：无BFS/记忆；k=0占28-67%，一个单位几乎静止守点，另一个主力扫荡；vp全部为0（不买视野）；单位贴中心核心区（（8，8）周围3x3游走，每轮2-3步小步移动）
